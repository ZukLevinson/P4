...
function Menu() {
    return (
                ...
                <div style={{margin: '10px', flex: '1', display: 'flex'}}>
                    ...
                    <div style={centerStyle}>
                        <div style={{height: '100%', flex:'1'}}>
                            <div style={{height: 'inherit', width: '100%',float:'left', display:'inline-block',verticalAlign:'top'}}>
                                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                     viewBox="0 0 57.945 57.945" style={{enableBackground: "new 0 0 57.945 57.945"}}>
                                    <g>
		...
		c-4.411,0-8,3.589-8,8s3.589,8,8,8s8-3.589,8-8C37,28.42,36.552,27.972,36,27.972z"/>
                        ...
                        </div><div style={{height: '100%', flex:'1'}}>
                        <div style={{height: 'inherit', width: '100%',float:'left', display:'inline-block',verticalAlign:'top'}}>
                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                 viewBox="0 0 57.945 57.945" style={{enableBackground: "new 0 0 57.945 57.945"}}>
                                <g>
